...
const services = [
  {
    title: "Правка позвоночника",
    description:
      "Вправление позвонков, снятие блоков и зажимов. Механическое воздействие для восстановления положения позвоночника.",
  },
  {
    title: "Правка атланта",
    description:
      "Постановка первого шейного позвонка. Снятие напряжения, головных болей и головокружений.",
  },
  {
    title: "Биомеханическая коррекция",
    description:
      "Восстановление естественного положения суставов и позвоночника без грубых манипуляций.",
  },
  {
    title: "Глубокий массаж спины",
    description:
      "Проработка мышц и фасций, снятие блоков и зажимов. Оздоровительный массаж при боли и напряжении.",
  },
  {
    title: "Снятие блоков и зажимов",
    description:
      "Мануальные техники для освобождения мышц и суставов, вытяжка позвоночника при необходимости.",
  },
  {
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div className="flex flex-col gap-2">
          ...
          <p className="typo-body text-text-colorslight-gray">
            Правка позвоночника, вправление позвонков, глубокий массаж спины и
            снятие блоков. Подбираю технику индивидуально, чтобы снять боль и
