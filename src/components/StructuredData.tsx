...
export const StructuredData = (): JSX.Element => {
  const structuredData = {
    ...
    description:
      "Костоправ в Ташкенте: вправление позвонков, правка позвоночника и атланта, снятие блоков и зажимов. При защемлении нерва, боли в пояснице, смещении позвонков - биомеханическая коррекция, глубокий массаж спины, оздоровительный массаж. Мануальная терапия, хиджама, моксотерапия.",
