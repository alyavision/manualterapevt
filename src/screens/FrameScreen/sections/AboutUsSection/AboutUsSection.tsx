...
const bulletPoints = [
  {
    text: "Правка позвоночника, вправление позвонков и атланта - работа с причиной боли, а не с симптомами",
  },
  {
    boldText: "7+ ",
    ...
    <section className="grid grid-cols-1 gap-8 md:grid-cols-12 md:items-center md:gap-10 lg:gap-12">
      <div className="flex justify-center md:col-span-5">
        <ResponsiveImage
          ...
          alt="Руслан Артыков - костоправ, мануальный терапевт в Ташкенте: правка позвоночника, вправление позвонков"
          mobileWidth={380}
          tabletWidth={420}
          desktopWidth={640}
          width={420}
        ...
        <div className="flex flex-col gap-6">
          <h2 className="typo-h2 text-text-colorsdark-gray">
            ...
            <span className="text-text-colorsdark-gray">
              мануальный терапевт и костоправ: правка позвоночника, вправление, возврат движения без боли
            </span>
          </h2>

          <p className="typo-body text-text-colorsdark-gray">
            Семь лет ежедневной практики, глубокое понимание анатомии и
            биомеханики позволяют точно находить источник боли и возвращать телу
            свободу движения. Делаю упор на механическое воздействие: вправить,
            поставить, размять. Индивидуальная диагностика, правка позвоночника
            и атланта, снятие блоков и зажимов, без грубых манипуляций.
          </p>
        </div>
